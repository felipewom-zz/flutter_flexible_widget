library flutter_flexible_widget;

import 'package:flutter/material.dart';

export 'flex_widget.dart';
export 'flexible_widget.dart';

mixin FlutterFlexible {
  ...
  static int calcColumns({Size size, Orientation orientation, Columns columns, BuildContext context}) {
    if (context != null) {
...
class Columns {
  ...
  Columns({@required int xs, int sm, int md, int lg, int xl, int xxl, int xxxl}) {
    values[FlutterFlexible.xs] = xs;
    values[FlutterFlexible.sm] = sm ?? values[FlutterFlexible.xs];
    values[FlutterFlexible.md] = md ?? values[FlutterFlexible.sm];
    values[FlutterFlexible.lg] = lg ?? values[FlutterFlexible.md];
    values[FlutterFlexible.xl] = xl ?? values[FlutterFlexible.lg];
    values[FlutterFlexible.xxl] = xxl ?? values[FlutterFlexible.xl];
    values[FlutterFlexible.xxxl] = xxxl ?? values[FlutterFlexible.xxl];
  }
}
