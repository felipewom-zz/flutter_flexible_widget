...
class FlexibleWidgetSettings extends InheritedWidget {
  final int columnsCount;

  FlexibleWidgetSettings(this.columnsCount, Widget child) : super(child: child);

  @override
  bool updateShouldNotify(FlexibleWidgetSettings old) => columnsCount != old.columnsCount;

  static FlexibleWidgetSettings of(BuildContext context) {
    return context.dependOnInheritedWidgetOfExactType(aspect: FlexibleWidgetSettings);
  }
}
